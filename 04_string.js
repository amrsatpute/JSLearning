...
console.log(
  "Index of char which is not available into the string: ",
  greet.indexOf("z")
);
...
console.log(
  ...
  myNameAfterTrim,
  myName.length,
  myNameAfterTrim.length
);

//find total extra spaces reoved from string myName
...
console.log(
  "Is substring Mor includes in the greet or not: ",
  greet.includes("Mor")
);
console.log(
  "Is substring Afternoon includes in the greet or not: ",
  greet.includes("Afternoon")
);
console.log(
  "Is substring o includes in the greet or not: ",
  greet.includes("o")
);
...
var myFriendList =
  "Billgates, Stew Job, Elon Musk, Ratan Tata, Sundar Pichai, Satya Nadella, Narayan Murti, Nandan Nilekani, Larry Page, Surgey Brain, Tim Cook";
