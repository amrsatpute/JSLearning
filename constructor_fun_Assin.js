...
const sbiBank = new Bank("Sbi Bank", "Pune", 736383, "SBI00098");
sbiBank.showDetails();
console.log(``);

const mahaBank = new Bank("Maha Bank", "Delhi", 04636, "MAHA09890");
mahaBank.showDetails();
console.log(``);

const hdfcBank = new Bank("Hdfc Bank", "Latur", 764633, "HDFC00965");
